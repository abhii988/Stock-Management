...
namespace SMS.Controllers
{
    public class PurchaseDetailsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.PurchaseDetail.Include(p => p.purchase);
        ...
        public async Task<IActionResult> Create([Bind("PurchaseDetailID,PurchaseID,ProductID,PhoneNumber,Email,Address")] PurchaseDetail purchaseDetail)
        {
